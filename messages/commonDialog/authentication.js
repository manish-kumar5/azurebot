...
module.exports = [
    function (session, args, next) {
        ...
        if (session.userdata && session.userdata.username) {
            ...
            msg += `<div class="form-group"><label class="col-sm-2 control-label" for="uid">User Name: </label><div class="col-sm-10"><input type="text" class ="form-control" id="uid"></div></div>`;
            msg += `<div class="form-group"><label class="col-sm-2 control-label" for="certno">Certificate #: </label><div class="col-sm-10"><input type="text" class ="form-control" id="certno"></div></div>`;
            // msg += `<div class ="form-group"><label for="pwd">Password : </label><input type="password" class ="form-control" id="pwd"></div>`;
            msg += `<div class="form-group"><label class="col-sm-2 control-label" for="dob">Date of Birth (MM-DD-YYYY): </label><div class="col-sm-10"><input type="text" class ="form-control" id="dob"></div></div>`;
            ...
            msg += `<div class="form-group"><label class="col-sm-2 control-label" for="tele">Telephone: </label><div class="col-sm-10"><input type="text" class ="form-control" id="tele"></div></div>`;
            msg += `<div class="form-group"><label class="col-sm-2 control-label" for="ssn">SSN (Last 4 digits): </label><div class="col-sm-10"><input type="text" class ="form-control" id="ssn" maxlength="4"></div></div>`;
