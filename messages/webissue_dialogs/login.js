...
module.exports = [
    ...
    function (session, results) {
        ...
        if (validuserid) {
            var passreset_msg = '<b>' + session.userData.username + '</b>,  I was able to confirm your login ID. If you’re having trouble logging in I can email you the instructions on how to set a new password. Would you like me to do that?';
